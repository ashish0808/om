...
?>
<div class="row-fluid">
	<?php echo $this->Html->link('Add New Todo', array('controller'=>'Todos','action'=>'add',trim(Inflector::slug($caseDetails['ClientCase']['computer_file_no']))), array('escape' => false, 'class' => 'tooltip-info btn btn-primary', 'data-rel' => 'tooltip', 'data-original-title'=>'Add new Todo'));
	?>
</div>
<?php
}
